...
def frame3d_KeMe(E,G,Kv,EA,EIx,EIy,EIz,L,A,Mass,R = None): 
    ...
    #    ux1 uy1 uz1 tx1 ty1 tz1   ux2  uy2 yz2 tx2 ty2 tz2
    ke = np.array([[a,0,0,0,0,0,- a,0,0,0,0,0],[0,b,0,0,0,c,0,- b,0,0,0,c],[0,0,d,0,- e,0,0,0,- d,0,- e,0],[0,0,0,f,0,0,0,0,0,- f,0,0],[0,0,- e,0,2 * g,0,0,0,e,0,g,0],[0,c,0,0,0,2 * h,0,- c,0,0,0,h],[- a,0,0,0,0,0,a,0,0,0,0,0],[0,- b,0,0,0,- c,0,b,0,0,0,- c],[0,0,- d,0,e,0,0,0,d,0,e,0],[0,0,0,- f,0,0,0,0,0,f,0,0],[0,0,- e,0,g,0,0,0,e,0,2 * g,0],[0,c,0,0,0,h,0,- c,0,0,0,2 * h]])
    # ---
    ...
    a2 = a ** 2
    r2 = EIx / E / A
    me = Mass / 2 / 105 * np.array([[70,0,0,0,0,0,35,0,0,0,0,0],[0,78,0,0,0,22 * a,0,27,0,0,0,- 13 * a],[0,0,78,0,- 22 * a,0,0,0,27,0,13 * a,0],[0,0,0,70 * r2,0,0,0,0,0,35 * r2,0,0],[0,0,- 22 * a,0,8 * a2,0,0,0,- 13 * a,0,- 6 * a2,0],[0,22 * a,0,0,0,8 * a2,0,13 * a,0,0,0,- 6 * a2],[35,0,0,0,0,0,70,0,0,0,0,0],[0,27,0,0,0,13 * a,0,78,0,0,0,- 22 * a],[0,0,27,0,- 13 * a,0,0,0,78,0,22 * a,0],[0,0,0,35 * r2,0,0,0,0,0,70 * r2,0,0],[0,0,13 * a,0,- 6 * a2,0,0,0,22 * a,0,8 * a2,0],[0,- 13 * a,0,0,0,- 6 * a2,0,- 22 * a,0,0,0,8 * a2]])
