...
from welib.yams.models.MTNSB import manual_assembly, auto_assembly
...
# TODO TODO TODO
def FASTmodel2MTNSB(FST_file, shapes_sub=[0,4], nShapes_bld=0, 
                    nSpan_twr=None, nSpan_sub=None, nSpan_bld=None, 
                    bHubMass=1, bNacMass=1, bBldMass=1, DEBUG=False, 
