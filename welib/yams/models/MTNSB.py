...
class FASTmodel2MTNSB(FASTWindTurbine):
    ...
    def __init__(self, FST_file, 
        ...
        Returns the following structure
          ...
          NOTE/TODO: compare this with "FNSB_FAST.py"
        """
        ...
        graph = self.SD.toGraph() # NOTE: this is repeated in bodies.py...
        graph.divideElements(self.SD['NDiv'])
        graph.sortNodesBy('z')
        ...
        self.setupEDGeom(zBot=zBot, bTiltBeforeNac=bTiltBeforeNac)
        ...
        # Bld
        Blds=[]
        Blds.append(FASTBeamBody('blade',ED,bldFile,Mtop=0,nShapes=nShapes_bld, nSpan=nSpan_bld, main_axis=main_axis, spanFrom0=spanFrom0, massExpected=bladeMassExpected, gravity=gravity, algo=algo)) # NOTE: legacy spanfrom0
        Blds[0].MM *=bBldMass
...
if __name__=='__main__':
    FASTmodel2MTNSB('C:/Users/ebranlard/Documents/Work/2024-10-OESI-Digitwin/DigiTwinMonopile/code5_wt/simulations_wt/06_Jonswap/OF_F3T1S1_H1A0_Hs=2.5_Tp=10.fst')
