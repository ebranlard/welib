...
#                                "(m/s)  ","(m/s)  ","(m/s)  ","(m/s)  ","(m/s)  ","(m/s)  "/)
    ...
    for sB in ['B1','B2','B3']:
        ...
        ADSpanMap['^[A]*'+sB+r'N(\d*)Vindxa_\[m/s\]']  =sB+'Vindxl_[m/s]'
        ADSpanMap['^[A]*'+sB+r'N(\d*)Vindya_\[m/s\]']  =sB+'Vindyl_[m/s]'
        ADSpanMap['^[A]*'+sB+r'N(\d*)Vindza_\[m/s\]']  =sB+'Vindzl_[m/s]'
        ...
        ADSpanMap['^[A]*'+sB+r'N(\d*)Fxp_\[N/m\]'   ]  =sB+'Fxl_[N/m]'   
        ADSpanMap['^[A]*'+sB+r'N(\d*)Fyp_\[N/m\]'   ]  =sB+'Fyl_[N/m]'   
        ADSpanMap['^[A]*'+sB+r'N(\d*)Fzp_\[N/m\]'   ]  =sB+'Fzl_[N/m]'   
        ADSpanMap['^[A]*'+sB+r'N(\d*)Mxp_\[N-m/m\]' ]  =sB+'Mxl_[N-m/m]'   
        ADSpanMap['^[A]*'+sB+r'N(\d*)Myp_\[N-m/m\]' ]  =sB+'Myl_[N-m/m]'   
        ADSpanMap['^[A]*'+sB+r'N(\d*)Mzp_\[N-m/m\]' ]  =sB+'Mzl_[N-m/m]'   
