    ...
    def init(self, initData):
        ...
        for i,n in enumerate(graph.Nodes):
            ...
            if n.point[2] >= -p['WtrDpth']:
                ...
                print('Connections',[e.ID for e in elem])
