...
1E+05                  UJacSclFact     - Scaling factor used in Jacobians (-)
...
---------------------- INPUT FILES ---------------------------------------------
"MT100_Baseline/ED.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"MT100_Baseline/SS_RegularWave.dat"               SeaStFile 
"MT100_Baseline/HD.dat"               HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)
"MT100_Baseline/SD.dat"               SubFile     - Name of file containing sub-structural input parameters (quoted string)
...
0, 10.0000             LinTimes    - List of times at which to linearize (s) [1 to NLinTimes] [used only when Linearize=True and CalcSteady=False]
