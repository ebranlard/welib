...
---------------------- INPUT FILES ---------------------------------------------
"MT100_Baseline/ED_3DOF.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"Waves/SS_Hs=8.1_Tp=12.7.dat"               SeaStFile 
