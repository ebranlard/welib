...
---------------------- INPUT FILES ---------------------------------------------
"ED_F3T1S1.dat"  EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"IW_TurbHat.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
"../IEA-22-280-RWT/IEA-22-280-RWT_AeroDyn15.dat"  AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"../IEA-22-280-RWT/IEA-22-280-RWT_ServoDyn.dat"   ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
"SS_Hs=8.1_Tp=12.7.dat"   SeaStFile   - Name of file containing sea state input parameters (quoted string)
"../IEA-22-280-RWT/IEA-22-280-RWT_HydroDyn.dat"   HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)
"../IEA-22-280-RWT/SD.dat"     SubFile     - Name of file containing sub-structural input parameters (quoted string)
...
"ES11.5E2"            OutFmt      - Format used for text tabular output, excluding the time channel.  Resulting field should be 10 characters. (quoted string)
---------------------- LINEARIZATION -------------------------------------------
...
0, 60.000000           LinTimes    - List of times at which to linearize (s) [1 to NLinTimes] [used only when Linearize=True and CalcSteady=False]
