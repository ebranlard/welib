...
"IEA-22-280-RWT_AeroDyn.dat"  AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
...
"IEA-22-280-RWT_SeaState.dat"   SeaStFile   - Name of file containing sea state input parameters (quoted string)
"IEA-22-280-RWT_HydroDyn.dat"   HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)
"SD.dat"     SubFile     - Name of file containing sub-structural input parameters (quoted string)
