...
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
     19000   TMax            - Total run time (s)
     0.1000   DT              - Recommended module time step (s)
...
---------------------- INPUT FILES ---------------------------------------------
"NREL5MW_ED_Onshore_Rigid.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"NREL5MW_IW_Step.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"NREL5MW_AD.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"../5MW_Baseline/NRELOffshrBsline5MW_Onshore_ServoDyn_Discon.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"NA"          SeaStFile       - Name of file containing sea state input parameters (-)
