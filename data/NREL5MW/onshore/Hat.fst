...
---------------------- INPUT FILES ---------------------------------------------
"Hat_ED.dat"       EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"unused"                        BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"unused"                        BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"unused"                        BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"Hat_IW.dat"      InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"Hat_AD.dat"         AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"../5MW_Baseline/NREL5MW_SvD.dat"      ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
