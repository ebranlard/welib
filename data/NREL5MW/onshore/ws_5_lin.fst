...
---------------------- INPUT FILES ---------------------------------------------
"ws_5_lin_ED.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"ws_5_lin_IW.dat" InflowFile    - Name of file containing inflow wind input parameters (quoted string)
"ws_5_lin_AD.dat" AeroFile      - Name of file containing aerodynamic input parameters (quoted string)
...
100.0, 101.33418721314975, 102.6683744262995, 104.00256163944925, 105.336748852599, 106.67093606574875 LinTimes - List of times at which to linearize (s) [1 to NLinTimes] [unused if Linearize=False]
