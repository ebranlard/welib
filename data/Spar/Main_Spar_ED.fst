...
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
      ...
      0.020   DT              - Recommended module time step (s)
...
"Spar_SS.dat"          SeaStFile       - Name of file containing sea state input parameters (quoted string)
...
"ES12.6E2"    OutFmt          - Format used for text tabular output, excluding the time channel.  
---------------------- LINEARIZATION -------------------------------------------
